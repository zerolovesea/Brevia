...
const liveSourceLabels = {
  zh: { '已连接': '已连接', '未就绪': '未就绪', '需要麦克风权限': '需要麦克风权限' },
  en: { '已连接': 'Connected', '未就绪': 'Not ready', '需要麦克风权限': 'Microphone permission required' },
  es: { '已连接': 'Conectado', '未就绪': 'No listo', '需要麦克风权限': 'Se requiere permiso de micrófono' },
  ja: { '已连接': '接続済み', '未就绪': '未準備', '需要麦克风权限': 'マイクのアクセス許可が必要です' },
  ko: { '已连接': '연결됨', '未就绪': '준비 안 됨', '需要麦克风权限': '마이크 권한이 필요합니다' },
  fr: { '已连接': 'Connecté', '未就绪': 'Pas prêt', '需要麦克风权限': 'Autorisation du microphone requise' },
  de: { '已连接': 'Verbunden', '未就绪': 'Nicht bereit', '需要麦克风权限': 'Mikrofonberechtigung erforderlich' },
  ru: { '已连接': 'Подключено', '未就绪': 'Не готово', '需要麦克风权限': 'Требуется доступ к микрофону' },
};
