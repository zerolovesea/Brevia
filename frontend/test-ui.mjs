...
const splash = await readFile('splash.html');
...
assert.match(text(electronMain), /splashFadeMs = 360/);
assert.match(text(electronMain), /splash\.setOpacity/);
assert.match(text(electronMain), /splash\.webContents\.once\('did-finish-load'/);
assert.match(text(electronMain), /startupDataWaitMs = 2200/);
assert.match(text(electronMain), /!mainReady \|\| !splashReady \|\| !animationComplete \|\| !initializationReady/);
assert.match(text(splash), /brevia-logo-reveal\.gif/);
