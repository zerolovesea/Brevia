...
assert.match(text(electronMain), /splash\.once\('did-finish-load', \(\) => splash\.show\(\)\)/);
...
assert.match(text(js), /permissions\.microphone === 'not-determined' \|\| permissions\.screen === 'not-determined'/);
