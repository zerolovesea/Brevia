...
assert.match(text(css), /\.transcript-scroll\{[^}]*grid-auto-rows:calc\(var\(--spacing\) \* 18\)/);
assert.match(text(css), /\.transcript-scroll \.segment p\{[^}]*-webkit-line-clamp:2/);
...
assert.match(text(css), /\.final-transcript\{[^}]*height:auto[^}]*overflow:hidden/);
