...
assert.match(text(tailwind), /\.live-panel \{ @apply col-start-10 col-span-3 grid min-h-0 min-w-0 grid-rows-\[minmax\(0,1fr\)_auto\]/);
...
assert.match(text(tailwind), /\.live-settings \.flow-select-options button \{ @apply grid gap-1 break-words whitespace-normal/);
...
assert.match(text(app), /renderRefinedModelChoices[\s\S]{0,600}refine-speaker-count/);
