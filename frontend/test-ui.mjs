...
assert.match(text(css), /\.transcript\{[^}]*grid-template-rows:auto 27rem auto auto/);
assert.match(text(css), /\.transcript-scroll \.segment\{[^}]*grid-template-columns:7rem minmax\(0,1fr\)/);
