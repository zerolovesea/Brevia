...
const uiData = {
  meetings: [
    { tone: 'violet', title: '产品策略周会', meta: '今天 09:30 · 42 分钟 · 产品', tags: ['需求评审', 'Q3'], status: { tone: 'complete', label: '已整理', detail: '3 项待办' } },
    { tone: 'mint', title: '向量数据库供应商沟通', meta: '昨天 15:10 · 31 分钟 · 外部会议', tags: ['供应商'], status: { tone: 'processing', label: '正在精修', detail: '双轨录音' } },
    { tone: 'coral', title: '设计系统对齐', meta: '7 月 26 日 · 56 分钟 · 设计', tags: ['设计', '组件库'], status: { tone: 'complete', label: '已整理', detail: '无待办' } }
  ],
  live: {
    transcript: [
  ...
  settings: {
    models: [{ icon: '⌁', name: 'SenseVoice Small', detail: '中文确认文本 · 1.2 GB' }, { icon: 'W', name: 'Whisper Small', detail: '英文与其他语言 · 466 MB' }],
