...
### Режимы производительности для устройств с CPU

В «Настройки → Производительность» доступны стандартный режим и режим эффективности. Режим эффективности отключает шумоподавление и уточнение в реальном времени и снижает частоту встроенных ИИ-заметок, чтобы субтитры оставались отзывчивыми; уточнение после встречи остаётся доступным. Если уточнение в реальном времени стабильно отстаёт, Brevia предложит тот же переход прямо во время встречи. На менее производительных устройствах используйте локальную модель 2B или онлайн-провайдера.
