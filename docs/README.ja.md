...
「設定 → パフォーマンス」では標準モードと効率モードを選べます。効率モードはリアルタイムのノイズ除去と精修を無効にし、内蔵 AIメモの頻度を下げて字幕の追従性を保ちます。会議後の精修は引き続き利用できます。リアルタイム精修が継続して滞留した場合も、会議中に切り替えを提案します。性能が低い端末では 2B のローカルモデルまたはオンラインプロバイダを推奨します。
