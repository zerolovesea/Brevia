...
contextBridge.exposeInMainWorld('brevia', {
  ...
  speakerProfile: { list: invoke('speaker-profile.list'), enroll: invoke('speaker-profile.enroll'), verify: invoke('speaker-profile.verify'), delete: invoke('speaker-profile.delete') },
